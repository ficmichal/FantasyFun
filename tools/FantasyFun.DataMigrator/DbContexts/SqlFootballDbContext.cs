...
{
    internal class SqlFootballDbContext : DbContext
    {
        public SqlFootballDbContext()
        {
        }

        protected override void OnConfiguring(DbContextOptionsBuilder options)
            => options.UseSqlServer("Server=.;Initial Catalog=FantasyFun;Integrated Security=true;MultipleActiveResultSets=True;Connection Timeout=360;");
